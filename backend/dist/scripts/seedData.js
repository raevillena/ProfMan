...
const mockData = {
    ...
    weekContents: {
        CS101: [
            { week: 1, title: 'Introduction to Programming', type: 'lecture' },
            { week: 2, title: 'Variables and Data Types', type: 'lecture' },
            { week: 3, title: 'Control Structures', type: 'lecture' },
            { week: 4, title: 'Functions and Modules', type: 'lecture' },
            { week: 5, title: 'Midterm Quiz', type: 'quiz' },
            { week: 6, title: 'Object-Oriented Programming', type: 'lecture' },
            { week: 7, title: 'Arrays and Lists', type: 'lecture' },
            { week: 8, title: 'File I/O', type: 'lecture' },
            { week: 9, title: 'Error Handling', type: 'lecture' },
            { week: 10, title: 'Final Project', type: 'exam' },
        ],
        CS201: [
            { week: 1, title: 'Introduction to Data Structures', type: 'lecture' },
            { week: 2, title: 'Arrays and Linked Lists', type: 'lecture' },
            { week: 3, title: 'Stacks and Queues', type: 'lecture' },
            { week: 4, title: 'Trees and Binary Trees', type: 'lecture' },
            { week: 5, title: 'Tree Traversal Quiz', type: 'quiz' },
            { week: 6, title: 'Binary Search Trees', type: 'lecture' },
            { week: 7, title: 'Hash Tables', type: 'lecture' },
            { week: 8, title: 'Graphs', type: 'lecture' },
            { week: 9, title: 'Sorting Algorithms', type: 'lecture' },
            { week: 10, title: 'Searching Algorithms', type: 'lecture' },
            { week: 11, title: 'Algorithm Analysis', type: 'lecture' },
            { week: 12, title: 'Final Exam', type: 'exam' },
        ],
    },
    quizQuestions: {
        CS101: [
...
async function seedBranches() {
    ...
    for (const subject of subjects) {
        try {
            ...
            const weekContents = mockData.weekContents[subject.code] || [];
                ...
                contents: [
                    {
                        ...
                        dueDate: week.type === 'quiz' || week.type === 'exam'
                            ? { seconds: Math.floor((Date.now() + (week.week * 7 * 24 * 60 * 60 * 1000)) / 1000), nanoseconds: 0 }
                            : undefined,
                    }
                ]
            }));
...
async function seedQuizzes() {
    ...
    for (const branch of branches) {
        try {
            ...
            const questions = mockData.quizQuestions[subjectCode] || [];
