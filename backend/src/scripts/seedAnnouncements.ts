...
interface AnnouncementData {
  ...
  audience: 'all' | 'students' | 'professors'
}

const announcementTemplates: AnnouncementData[] = [
  {
...
async function seedAnnouncements() {
  ...
  for (const branch of branches) {
    try {
      // Check if announcements already exist for this branch
      ...
      // Create 3-6 announcements per branch
